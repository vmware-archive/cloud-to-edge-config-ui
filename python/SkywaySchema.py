...
def createTableEnvironments(cursor):
    cursor.execute('''CREATE TABLE IF NOT EXISTS Environments(
            ...
            ovftool_image text,
            skyway_edge_vm_basename text,
            skyway_edge_vm_user text,
            skyway_edge_vm_password text,
            skyway_edge_vm_network text,
            skyway_edge_vm_ssh_priv_key text,
            skyway_edge_vm_ssh_pub_key text,
